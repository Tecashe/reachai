...
const steps = [
  {
    ...
    image: "interface showing email account connection wizard with Gmail Outlook icons",
  },
  {
    number: "02",
    ...
    image: "lead import interface showing CSV upload and data enrichment preview",
  },
  {
    number: "03",
    ...
    image: "email sequence builder with drag and drop steps and AI writing assistant",
  },
  {
    number: "04",
    ...
    image: "campaign dashboard showing live metrics replies and optimization suggestions",
  },
]
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center p-8 sm:p-12 lg:p-16 pt-20 sm:pt-24">
                      ...
                      >
                        <img
                          src={`/.jpg?height=500&width=800&query=${step.image}`}
                          alt={step.title}
