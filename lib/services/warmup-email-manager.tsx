...
//     const inboxCount = lock.exists || 0
//     lock.release()
...
//     const interactions = await prisma.warmupInteraction.aggregate({
//       _count: true,
//       _avg: {
//         landedInInbox: true,
//       },
...
//       accountsInPoolStage,
//       accountsInPeerStage,
//       totalEmailsSent: interactions._count || 0,
//       totalRepliesReceived: await prisma.warmupInteraction.count({
//         where: { direction: "INBOUND" },
//       }),
//       avgInboxPlacement,
//       replyRate: 0,
//       totalInteractions: interactions._count || 0,
//     }
//   },
