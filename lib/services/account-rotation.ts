...
//     // CHANGE: Implement different rotation strategies
...
//       const aRecentCount = a.sentEmails?.length || 0
//       const bRecentCount = b.sentEmails?.length || 0
...
//       const total = account.sentEmails.length
//       const delivered = account.sentEmails.filter((e) => e.status === "DELIVERED").length
...
//         rotations: account.rotationCount || 0,
//       }
//     })
