...
//   const [selectedCategory, setSelectedCategory] = useState<string>("all")
//   const [selectedIndustry, setSelectedIndustry] = useState<string>("all")
//   const [activeTab, setActiveTab] = useState<string>(isEmbedded ? "my-templates" : "all")
//   const [isPending, startTransition] = useTransition()
//   const [previewTemplate, setPreviewTemplate] = useState<EnhancedEmailTemplate | null>(null)
...
//         })
//       } else {
//         toast.error("Error", { description: result.error || "Failed to duplicate template" })
//       }
//     },
//     [onRefresh, router],
//   )
...
//         })
//       } else {
//         toast.error("Error", { description: result.error || "Failed to delete template" })
//       }
//     },
//     [onRefresh, router],
//   )
...
//       if (result.success) {
//         // If a system template was favorited, it was duplicated - refresh to show the new copy
//         if (result.duplicatedId) {
//           toast.success("Template added to your library", {
//             description: "The template has been duplicated to your personal library and marked as favorite.",
//           })
//           startTransition(() => {
//             if (onRefresh) {
//               onRefresh()
...
//         }
//       } else {
//         toast.error("Error", { description: result.error || "Failed to update favorite" })
//       }
//     },
//     [onRefresh, router],
//   )
...
//               Browse and use high-converting email templates for your campaigns
//             </p>
//           </div>
...
//                 ))}
//               <DropdownMenuSeparator />
//               <div className="px-2 py-1.5 text-sm font-semibold">Industries</div>
//               <DropdownMenuCheckboxItem
//                 checked={selectedIndustry === "all"}
//                 onCheckedChange={() => setSelectedIndustry("all")}
//               >
...
//               Favorites
//             </TabsTrigger>
//             <TabsTrigger value="my-templates" className="text-sm font-medium">
//               My Templates
//             </TabsTrigger>
...
//                     ? "You haven't created any templates yet. Create your first template to get started."
//                     : activeTab === "favorites"
//                       ? "You haven't favorited any templates yet. Browse templates and click the heart icon to save your favorites."
//                       : "Try adjusting your filters or search query to find templates."}
//                 </p>
//                 {activeTab === "my-templates" && !isEmbedded && (
