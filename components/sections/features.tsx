...
const features = [
  {
    ...
    image: "dashboard showing multiple connected email accounts with rotation settings",
  },
  {
    ...
    image: "email warmup dashboard showing gradual increase in sending volume chart",
  },
  {
    ...
    image: "interface showing email distribution across multiple inboxes with analytics",
  },
  {
    ...
    image: "analytics dashboard showing deliverability metrics and inbox placement rates",
  },
  {
    ...
    image: "email composer with AI suggestions and personalization variables highlighted",
  },
  {
    ...
    image: "comprehensive analytics dashboard with charts showing campaign performance metrics",
  },
]
        ...
        <div className="absolute top-0 left-0 right-0 overflow-hidden py-6 sm:py-8 border-b border-background/10">
          ...
          >
            {[...Array(4)].map((_, i) => (
              ...
              >
                <span>Everything you need to scale cold outreach</span>
          ...
          <div className="w-full lg:w-1/2 h-[40vh] lg:h-[70%] flex items-center justify-center">
            ...
            >
              ...
              {features.map((feature, index) => (
                ...
                >
                  <img
                    src={`/.jpg?height=600&width=800&query=${encodeURIComponent(feature.image)}`}
                    alt={feature.title}
