...
export default async function DashboardPage() {
  ...
  return (
    <div className="space-y-8 p-6 lg:p-8 max-w-[1600px] mx-auto">
      ...
      {/* Stats Grid - Premium glassmorphic cards */}
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      {/* Credits Row - Modern dual-card layout */}
      ...
      {/* Donut Charts Row - Enhanced with better spacing */}
      <div className="grid gap-6 md:grid-cols-3">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        {/* Domain Health - Radial Progress with enhanced styling */}
