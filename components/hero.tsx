...
//   const navWidth = navPhase === 1 ? 90 + navTransition1 * 8 : navPhase === 2 ? 98 - navTransition2 * 10 : 88
//   const navHeight = navPhase === 1 ? 56 + navTransition1 * 8 : navPhase === 2 ? 64 : 64
//   const navBorderRadius = navPhase === 1 ? 9999 - navTransition1 * 9960 : navPhase === 2 ? 39 + navTransition2 * 9960 : 9999
//   const navY = navPhase === 3 ? 8 + navTransition3 * 8 : navTransition1 * 8
//   const navBlur = 20 + scrollProgress * 30
...
//         {/* === IMPROVED BACKGROUND ORBS === */}
//         <div
//           className="absolute inset-0 overflow-hidden pointer-events-none transition-all duration-1000"
//           style={{
//             opacity: (1 - phase1Progress * 0.3) * (1 - phase3Progress * 0.6),
//             transform: `scale(${1 + scrollProgress * 0.15})`,
//           }}
//         >
//           {/* Orb 1 - Top Right */}
//           <div
//             className="absolute -top-20 right-1/4 w-[200px] sm:w-[300px] lg:w-[400px] h-[200px] sm:h-[300px] lg:h-[400px]"
//             style={{
//               background: isDark 
//                 ? "radial-gradient(ellipse at 30% 30%, rgba(99, 102, 241, 0.15), rgba(59, 130, 246, 0.05), transparent)"
//                 : "radial-gradient(ellipse at 30% 30%, rgba(255,255,255,0.8), rgba(245,247,255,0.3), transparent)",
//               borderRadius: "60% 40% 50% 50% / 50% 60% 40% 50%",
//               filter: `blur(${isDark ? '60px' : '40px'})`,
//               animation: "morph1 20s ease-in-out infinite, float1 15s ease-in-out infinite",
//             }}
//           />
...
//           {/* Orb 2 - Left Middle */}
//           <div
//             className="absolute top-1/2 -left-16 sm:-left-24 lg:-left-32 w-[150px] sm:w-[220px] lg:w-[300px] h-[150px] sm:h-[220px] lg:h-[300px]"
//             style={{
//               background: isDark
//                 ? "radial-gradient(ellipse at 60% 40%, rgba(139, 92, 246, 0.12), rgba(168, 85, 247, 0.04), transparent)"
//                 : "radial-gradient(ellipse at 60% 40%, rgba(255,255,255,0.7), rgba(240,242,255,0.25), transparent)",
//               borderRadius: "50% 60% 40% 50% / 40% 50% 60% 50%",
//               filter: `blur(${isDark ? '50px' : '30px'})`,
//               animation: "morph2 25s ease-in-out infinite, float2 18s ease-in-out infinite",
//             }}
//           />
...
//           {/* Orb 3 - Bottom Right */}
//           <div
//             className="absolute bottom-20 right-8 sm:right-12 lg:right-16 w-[120px] sm:w-[180px] lg:w-[240px] h-[120px] sm:h-[180px] lg:h-[240px]"
//             style={{
//               background: isDark
//                 ? "radial-gradient(ellipse at 40% 30%, rgba(236, 72, 153, 0.1), rgba(219, 39, 119, 0.03), transparent)"
//                 : "radial-gradient(ellipse at 40% 30%, rgba(255,255,255,0.9), rgba(248,249,255,0.3), transparent)",
//               borderRadius: "40% 60% 50% 50% / 60% 40% 50% 50%",
//               filter: `blur(${isDark ? '45px' : '25px'})`,
//               animation: "morph3 18s ease-in-out infinite, float3 12s ease-in-out infinite",
//             }}
//           />
...
//             background: isDark
//               ? navPhase === 3
//                 ? `linear-gradient(135deg, rgba(30,30,30,${0.95 + navTransition3 * 0.05}), rgba(20,20,20,${0.9 + navTransition3 * 0.1}))`
//                 : `linear-gradient(135deg, rgba(30,30,30,${0.85 + navTransition1 * 0.15}), rgba(20,20,20,${0.7 + navTransition1 * 0.3}))`
//               : navPhase === 3
//                 ? `linear-gradient(135deg, rgba(17,17,17,${0.95 + navTransition3 * 0.05}), rgba(30,30,30,${0.9 + navTransition3 * 0.1}))`
//                 : `linear-gradient(135deg, rgba(255,255,252,${0.85 + navTransition1 * 0.15}), rgba(250,250,252,${0.7 + navTransition1 * 0.3}))`,
//             backdropFilter: `blur(${navBlur}px) saturate(180%)`,
//             boxShadow: isDark
//               ? navPhase === 3
//                 ? `0 0 40px rgba(99, 102, 241, 0.15), 0 25px 50px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.1)`
//                 : `0 ${20 + navTransition1 * 20}px ${40 + navTransition1 * 40}px rgba(0,0,0,${0.4 + navTransition1 * 0.2}), inset 0 1px 0 rgba(255,255,255,0.05)`
//               : navPhase === 3
//                 ? `0 0 60px rgba(200,200,255,0.1), 0 25px 50px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.15)`
//                 : `0 ${20 + navTransition1 * 20}px ${40 + navTransition1 * 40}px rgba(0,0,0,${0.08 + navTransition1 * 0.07}), inset 0 1px 0 rgba(255,255,255,1)`,
//             border: isDark
//               ? `1px solid rgba(255,255,255,${0.08 + navTransition3 * 0.08})`
//               : navPhase === 3
//                 ? `1px solid rgba(255,255,255,${0.1 + navTransition3 * 0.1})`
//                 : `1px solid rgba(255,255,255,${0.8 - navTransition1 * 0.3})`,
//             padding: `0 ${Math.max(12, 16 + navTransition1 * 8)}px`,
...
//                   : navPhase === 3
//                     ? `0 0 20px rgba(255,255,255,0.5), 0 8px 20px rgba(0,0,0,0.3)`
...
//                   isDark ? "brightness-0 invert" : navPhase === 3 ? "brightness-0" : "brightness-0 invert"
//                 }`}
//                 priority
//               />
//             </div>
...
//                 key={item}
//                 href="/dashboard"
//                 className="px-3 py-2 text-sm font-medium rounded-full transition-all duration-300 whitespace-nowrap hover:bg-accent"
//                 style={{
//                   transform: `translateX(${(i - 1.5) * navTransition1 * 8}px)`,
//                 }}
//               >
...
//             <Link
//               href="/dashboard"
//               className="hidden md:block px-3 py-2 text-sm font-medium rounded-full transition-all duration-300 whitespace-nowrap hover:bg-accent"
//             >
//               Sign In
//             </Link>
//             <Link href="/sign-up" className="hidden sm:block">
...
//                   color: isDark ? "#fff" : navPhase === 3 ? "#111" : "#fff",
//                   boxShadow: isDark
//                     ? `0 0 30px rgba(99, 102, 241, 0.3), 0 10px 25px rgba(0,0,0,0.3)`
//                     : navPhase === 3
//                       ? `0 0 30px rgba(255,255,255,0.3), 0 10px 25px rgba(0,0,0,0.2)`
...
//             style={{
//               borderRadius: `${navBorderRadius}px`,
//               opacity: (scrollProgress > 0.1 && scrollProgress < 0.4) || (scrollProgress > 0.55 && scrollProgress < 0.75) ? 1 : 0,
//             }}
//           >
//             <div
//               className="absolute inset-0"
...
//             <div className="flex flex-col items-center justify-center h-full gap-6 p-8">
//               {["Features", "Pricing", "Customers", "Resources", "Sign In"].map((item: string) => (
//                 <Link
//                   key={item}
//                   href="/dashboard"
//                   onClick={() => setMobileMenuOpen(false)}
...
//           style={{
//             opacity: contentOpacity,
//             transform: `scale(${contentScale}) translateY(${contentY}px) perspective(1000px) rotateX(${contentRotateX}deg)`,
//             transformOrigin: "center top",
//           }}
//         >
//           <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center pointer-events-auto pt-24 sm:pt-20">
//             <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold leading-[1.05] mb-6 sm:mb-8 text-balance">
//               Generate leads in{" "}
//               <span className="relative inline-block">
//                 <span className="relative z-10">14 days</span>
//                 <svg
...
//                 size="lg"
//                 variant="outline"
//                 className="w-full sm:w-auto text-base sm:text-lg h-14 sm:h-16 px-8 sm:px-10 rounded-full transition-all duration-300 hover:-translate-y-1 group backdrop-blur-sm"
//               >
//                 <Play className="mr-2 w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" />
//                 Watch Demo
//               </Button>
