...
//         ...b,
//         trafficPercent: i === newBranches.length - 1 
//           ? 100 - (equalPercent * (newBranches.length - 1))
//           : equalPercent
//       }))
...
//       const updated = config.branches.map(b => 
...
//             <Button size="sm" variant="outline" onClick={addBranch} className="h-7 gap-1.5 px-2" disabled={config.branches.length >= 5}>
...
//                 const conversionRate = branch.stats.entered > 0
//                   ? ((branch.stats.converted / branch.stats.entered) * 100).toFixed(1)
//                   : "0.0"
...
//                           />
//                         </div>
//                         <Button size="icon" variant="ghost" onClick={() => removeBranch(branch.id)} className="h-7 w-7 text-destructive" disabled={config.branches.length <= 1}>
...
//                 onChange={(e) => onUpdate({ abSplitConfig: { ...config, winnerThreshold: parseInt(e.target.value) || 100 } })}
//                 className="h-8"
//               />
//               <p className="text-xs text-muted-foreground">After {config.winnerThreshold} total sends, best variant wins</p>
//             </div>
//           )}
...
//               onChange={(e) => onUpdate({ behaviorBranchConfig: { ...config, evaluationPeriodDays: parseInt(e.target.value) || 3 } })}
//               className="h-8 w-20"
//             />
...
//             <Button size="sm" variant="outline" onClick={addBranch} className="h-7 gap-1.5 px-2">
//               <Plus className="h-3.5 w-3.5" />
//               Add Path
//             </Button>
//           </div>
...
//                 const conversionRate = branch.stats.entered > 0 ? ((branch.stats.converted / branch.stats.entered) * 100).toFixed(1) : "0.0"
...
//                           />
//                         </div>
//                         <Button size="icon" variant="ghost" onClick={() => removeBranch(branch.id)} className="h-7 w-7 text-destructive">
//                           <Trash2 className="h-3.5 w-3.5" />
//                         </Button>
//                       </div>
//                     </CardHeader>
...
//                         <Select value={branch.condition} onValueChange={(v) => updateBranch(branch.id, { condition: v as BehaviorCondition })}>
...
//                         <Switch
//                           checked={isDefault}
//                           onCheckedChange={(checked) => onUpdate({ behaviorBranchConfig: { ...config, defaultBranchId: checked ? branch.id : null } })}
//                         />
//                       </div>
//                       {branch.stats.entered > 0 && (
//                         <div className="grid grid-cols-3 gap-2 pt-2 border-t">
...
//           <p className="text-xs">Add natural variation to avoid spam filters. One variant is randomly selected per prospect.</p>
//         </div>
//       </div>
...
//           onValueChange={(v) => onUpdate({ randomVariantConfig: { ...config, variationType: v as typeof config.variationType } })}
//         >
...
//           <Button size="sm" variant="outline" onClick={addVariant} className="h-7 gap-1.5 px-2">
//             <Plus className="h-3.5 w-3.5" />
//             Add Variant
//           </Button>
//         </div>
...
//                       <Button size="icon" variant="ghost" onClick={() => removeVariant(variant.id)} className="h-6 w-6 text-destructive">
...
//           onValueChange={(v) => onUpdate({ contentReferenceConfig: { ...config, resourceType: v as typeof config.resourceType } })}
//         >
//           <SelectTrigger><SelectValue /></SelectTrigger>
//           <SelectContent>
...
//                         onTimeSpent: { seconds: parseInt(e.target.value) || 120, stepId: "" } 
//                       } 
//                     } 
//                   })}
//                   className="h-8 w-24"
...
//           />
//           <p className="text-xs text-muted-foreground">
//             Message will be read by AI voice. Keep it under 30 seconds.
//           </p>
//         </div>
//       ) : (
//         <div className="space-y-2">
...
//           onCheckedChange={(checked) => onUpdate({ voicemailDropConfig: { ...config, personalizeWithVariables: checked } })}
//         />
//       </div>
...
//           onValueChange={(v) => onUpdate({ voicemailDropConfig: { ...config, integrationId: v === "none" ? null : v } })}
//         >
...
//             onCheckedChange={(checked) => onUpdate({ directMailConfig: { ...config, followUpEmailEnabled: checked } })}
//           />
//         </div>
...
//               onChange={(e) => onUpdate({ directMailConfig: { ...config, followUpDelay: parseInt(e.target.value) || 3 } })}
//               className="h-8 w-20"
//             />
//           </div>
//         )}
...
//           onCheckedChange={(checked) => onUpdate({ multiChannelConfig: { ...config, executeSimultaneously: checked } })}
//         />
//       </div>
...
//             onChange={(e) => onUpdate({ multiChannelConfig: { ...config, delayBetweenTouches: parseInt(e.target.value) || 60 } })}
//             className="h-8 w-24"
//           />
//         </div>
//       )}
...
//                       </div>
//                       <Button size="icon" variant="ghost" onClick={() => removeTouch(touch.id)} className="h-7 w-7 text-destructive">
//                         <Trash2 className="h-3.5 w-3.5" />
//                       </Button>
//                     </div>
//                   </CardContent>
...
//             onChange={(e) => onUpdate({ 
//               conditions: { ...conditions, sendIf: { ...conditions.sendIf, companySizeGreaterThan: parseInt(e.target.value) } } 
//             })}
//             placeholder="50"
//             className="h-8 w-32"
//           />
...
//             onChange={(e) => onUpdate({ 
//               conditions: { ...conditions, sendIf: { ...conditions.sendIf, leadScoreGreaterThan: parseInt(e.target.value) } } 
//             })}
//             placeholder="70"
//             className="h-8 w-32"
//           />
...
//             onChange={(e) => onUpdate({ 
//               conditions: { ...conditions, sendIf: { ...conditions.sendIf, daysInStep: parseInt(e.target.value) } } 
//             })}
//             placeholder="3"
//             className="h-8 w-32"
//           />
