...
//   return (
//     <section id="features" className="py-20 md:py-32" ref={ref}>
//       <div className="container">
//         <motion.div
...
//             >
//               <Card className="border-border/50 hover:border-border transition-all hover:shadow-lg hover:shadow-blue-500/10 h-full">
//                 <CardContent className="p-6">
//                   <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-blue-500/10 to-cyan-500/10 shadow-md">
//                     <feature.icon className="h-6 w-6 text-blue-600 dark:text-blue-400" />
//                   </div>
//                   <h3 className="mb-2 text-lg font-semibold">{feature.title}</h3>
//                   <p className="text-sm text-muted-foreground leading-relaxed">{feature.description}</p>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => (
            <motion.div
              ...
              transition={{ duration: 0.5, delay: index * 0.1 }}
            >
              <Card className="border-border/50 hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/10 h-full">
                <CardContent className="p-6">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-primary/10 to-accent/10 shadow-md">
