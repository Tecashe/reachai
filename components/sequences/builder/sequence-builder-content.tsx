...
//       // Delete step: Delete/Backspace when step is selected
...
//     // Update order for steps after the new one
...
//     // If sequence is already saved, create step in DB
//     if (sequence.id !== "new") {
//       try {
...
//     // If it's a real step (not temp), delete from DB
...
//     // If sequence is saved, update in DB
//     if (sequence.id !== "new") {
//       try {
//         await reorderSteps(
//           sequence.id,
...
//         // Update all pending step changes
...
//         description: `Sequence is now ${newStatus.toLowerCase()}.`,
//       })
//     } catch (error) {
//       toast({
//         title: "Error",
...
//       toast({
//         title: "Duplicated!",
//         description: "Sequence has been duplicated.",
//       })
//       router.push(`/sequences/${duplicated.id}`)
//     } catch (error) {
//       toast({
//         title: "Error",
...
//       toast({
//         title: "Archived",
//         description: "Sequence has been archived.",
//       })
//       router.push("/sequences")
//     } catch (error) {
//       toast({
//         title: "Error",
//         description: "Failed to archive sequence.",
//         variant: "destructive",
//       })
//     }
//   }
...
//           <Button variant="ghost" size="icon" onClick={() => router.push("/sequences")} className="h-8 w-8">
...
//             </Button>
//             <span className="min-w-[3rem] text-center text-sm text-muted-foreground">{zoomLevel}%</span>
...
//           <SequenceAnalyticsPanel sequenceId={sequence.id} userId={userId} steps={steps} />
//         )}

//         {activeTab === "prospects" && sequence.id !== "new" && (
//           <SequenceProspectsPanel sequenceId={sequence.id} userId={userId} />
//         )}
//       </div>
...
export function SequenceBuilderContent({ initialSequence, isNew = false, userId }: SequenceBuilderContentProps) {
  ...
  return (
    <div className="flex h-screen flex-col bg-background overflow-hidden">
      {/* Header - Added sticky positioning, z-index, and subtle shadow for depth */}
      ...
      {/* Tab bar - Added sticky positioning and z-index to keep it fixed below header */}
      ...
      {/* Main content - Added flex-1 and min-h-0 to allow proper flex shrinking and scrolling */}
      <div className="flex flex-1 min-h-0 overflow-hidden">
        {activeTab === "builder" && (
          <>
            {/* Canvas - Added overflow-auto to make only the canvas scrollable */}
            ...
            {/* Step panel - Added flex column layout with independent scrolling */}
            {selectedStep && (
            ...
            {/* Settings panel - Added flex column layout with independent scrolling */}
            {activePanel === "settings" && !selectedStep && (
              <div className="w-[420px] shrink-0 border-l border-border bg-card flex flex-col overflow-hidden">
                <div className="flex-1 overflow-y-auto">
                  <SequenceSettingsPanel
